...
exports.create = function(req, res) {
  ...
  Question.insertMany(questionArray,function(errors,docs){
    if(errors){
      return res.status(400).send({
        message: "Error occured while uploading. Please recheck the the fields in upload file "
      });
    }else{
...
exports.download = function(req,res){
  var data= [['Question','Option 1','Option 2','Option 3','Option 4','Answer(1-4)','Skill','Expertise(1-3)']];
